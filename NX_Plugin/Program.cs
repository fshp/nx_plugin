    ...
    public class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            try
            {
                ...
                theUfSession.Modl.CreateChamfer(3, offset.ToString(), offset.ToString(), angle.ToString(), list, out obj_id_camf);

                ////////////////////////////////
                
                double[] l1_endpt1 = { 0, -r, -rp };
                double[] l1_endpt2 = { 0, r, -rp };
                double[] l2_endpt1 = l1_endpt2;
                double[] l2_endpt2 = { 0, r, rp };
                double[] l3_endpt1 = l2_endpt2;
                double[] l3_endpt2 = { 0, -r, rp };
